...
//    double totalDurationSeconds = parseDurationSeconds(requestUri.getQueryParameter("duration"), 12.074666);
//    double assetDurationSeconds = totalDurationSeconds / 2;

    double assetDurationSeconds = 6.037333;
    JSONArray assets = new JSONArray();
    assets.put(buildAssetJson(requestUri, interstitialId, "interstitial-1.ts", assetDurationSeconds, 1));
    assets.put(buildAssetJson(requestUri, interstitialId, "interstitial-2.ts", assetDurationSeconds, 2));
